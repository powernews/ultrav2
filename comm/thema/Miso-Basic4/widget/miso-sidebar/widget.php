        ...
        <div class="sidebar-wing-icon en">
            ...
            <a href="javascript:;" onclick="sidebar_open('sidebar-response');" title="알림">
				<span class="sidebar-wing-btn bg-navy">
                    ...
                    <?php if ($is_member) { ?>
                        <span
                            class="sidebar-wing-label en bg-orangered sidebarLabel"<?php echo ($member['response'] || $member['memo']) ? '' : ' style="display:none;"'; ?>>
                ...
                <a href="javascript:;" onclick="sidebar_open('sidebar-cart');" title="쇼핑">
					<span class="sidebar-wing-btn bg-navy">
                        ...
                        <?php if ($member['cart'] || $member['today']) { ?>
                            <span
                                class="sidebar-wing-label en bg-orangered"><?php echo $member['cart'] + $member['today']; ?></span>
                        <?php } ?>
					</span>
                </a>
            <?php } ?>
    ...
    <div id="sidebar-content" class="sidebar-content">
        ...
        <div class="sidebar-common">
            ...
            <div class="btn-group btn-group-justified" role="group">
                <?php if ($is_member) { ?>
                    <a href="#" onclick="sidebar_open('sidebar-user'); return false;"
                       class="btn btn-navy btn-sm">내정보</a>
                    <?php if ($member['admin']) { ?>
                ...
                <?php } else { ?>
                    <a href="#" onclick="sidebar_open('sidebar-user'); return false;"
                       class="btn btn-navy btn-sm">로그인</a>
    ...
    <ul>
            ...
            <a href="javascript:;" onclick="sidebar_open('sidebar-response');" title="알림">
				<span class="sidebar-btn-box bg-navy">
					<span class="sidebar-btn">
                        ...
                        <?php if ($is_member) { ?>
                            <span
                                class="sidebar-btn-label en bg-orangered sidebarLabel"<?php echo ($member['response'] || $member['memo']) ? '' : ' style="display:none;"'; ?>>
								<span class="sidebarCount"><?php echo $member['response'] + $member['memo']; ?></span>
							</span>
                        <?php } ?>
					</span>
            ...
            <li>
				...
				<span class="sidebar-btn-box bg-navy">
					<span class="sidebar-btn">
                        ...
                        <?php if ($member['cart'] || $member['today']) { ?>
                            <span
                                class="sidebar-btn-label en bg-orangered"><?php echo $member['cart'] + $member['today']; ?></span>
                        <?php } ?>
					</span>
				</span>
                </a>
        ...
        <? if (!G5_IS_MOBILE) { ?>
            <li style="margin-bottom: 5px;">
                <a href="https://www.facebook.com/ultravmaster" target="_blank" class="sidebar_left_01" title="페이스북">
						<img src="http://bandiworld.co.kr/comm/main/images/sns_r1_c1.png" width="42" height="42">
                </a>
            </li>
            <li style="margin-bottom: 5px;">
                <a href="https://www.instagram.com/ultravcosmetic" target="_blank" class="sidebar_left_02" title="인스타그램">
						<img src="http://bandiworld.co.kr/comm/main/images/sns_r3_c1.png" width="42" height="42">
                </a>
            </li>
            <li>
                <a href="http://blog.naver.com/wmmodel" target="_blank" class="sidebar_left_03" title="블로그">
                    <img src="http://bandiworld.co.kr/comm/main/images/sns_r5_c1.png" width="42" height="42">
                </a>
            </li>
        <? } ?>
        <!--------------------------------------------------------->
