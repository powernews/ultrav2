...
<style>
	.main-wrap { padding:0px; margin-right:-2px; overflow:hidden; }
...
<div class="main-wrap">
	<?php if($m == "2") { //히트 ?>
		<?php echo apms_widget('miso-shop-item-photo', $wshid.'-photo2', 'type=1 infi=2 gap_r=0 gap_b=0 garo=6 sero=5 lg=4 md=3 sm=2 xs=1 hit=1 cmt=1 sns=1 thumb_w=400 thumb_h=600'); ?>
	
	<?php } else if($m == "3") { //추천 ?>
		<?php echo apms_widget('miso-shop-item-photo', $wshid.'-photo3', 'type=2 infi=2 gap_r=0 gap_b=0 garo=6 sero=5 lg=4 md=3 sm=2 xs=1 hit=1 cmt=1 sns=1 thumb_w=400 thumb_h=600'); ?>

	<?php } else if($m == "4") { //신규 ?>
		<?php echo apms_widget('miso-shop-item-photo', $wshid.'-photo4', 'type=3 infi=2 gap_r=0 gap_b=0 garo=6 sero=5 lg=4 md=3 sm=2 xs=1 hit=1 cmt=1 sns=1 thumb_w=400 thumb_h=600'); ?>

	<?php } else if($m == "5") { //인기 ?>
		<?php echo apms_widget('miso-shop-item-photo', $wshid.'-photo5', 'type=4 infi=2 gap_r=0 gap_b=0 garo=6 sero=5 lg=4 md=3 sm=2 xs=1 hit=1 cmt=1 sns=1 thumb_w=400 thumb_h=600'); ?>

	<?php } else if($m == "6") { //할인 ?>
		<?php echo apms_widget('miso-shop-item-photo', $wshid.'-photo6', 'type=5 infi=2 gap_r=0 gap_b=0 garo=6 sero=5 lg=4 md=3 sm=2 xs=1 hit=1 cmt=1 sns=1 thumb_w=400 thumb_h=600'); ?>

	<?php } else { //전체 ?>
		<?php echo apms_widget('miso-shop-item-photo', $wshid.'-photo1', 'infi=2 gap_r=0 gap_b=0 garo=6 sero=5 lg=4 md=3 sm=2 xs=1 hit=1 cmt=1 sns=1 thumb_w=400 thumb_h=600'); ?>
	<?php } ?>
</div>
