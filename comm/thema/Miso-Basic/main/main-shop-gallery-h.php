		...
		<div class="container">
			...
			<div class="row main-row">
				<div class="col-md-9 main-col">
					...
					<?php if($m == "2") { //히트 ?>
						<?php echo apms_widget('miso-shop-item-gallery', $wshid.'-gallery2', 'type=1 infi=1 garo=3 sero=5 sm=2 xs=1 hit=1 cmt=1 sns=1 thumb_w=400 thumb_h=600'); ?>
					
					<?php } else if($m == "3") { //추천 ?>
						<?php echo apms_widget('miso-shop-item-gallery', $wshid.'-gallery3', 'type=2 infi=1 garo=3 sero=5 sm=2 xs=1 hit=1 cmt=1 sns=1 thumb_w=400 thumb_h=600'); ?>

					<?php } else if($m == "4") { //신규 ?>
						<?php echo apms_widget('miso-shop-item-gallery', $wshid.'-gallery4', 'type=3 infi=1 garo=3 sero=5 sm=2 xs=1 hit=1 cmt=1 sns=1 thumb_w=400 thumb_h=600'); ?>

					<?php } else if($m == "5") { //인기 ?>
						<?php echo apms_widget('miso-shop-item-gallery', $wshid.'-gallery5', 'type=4 infi=1 garo=3 sero=5 sm=2 xs=1 hit=1 cmt=1 sns=1 thumb_w=400 thumb_h=600'); ?>

					<?php } else if($m == "6") { //할인 ?>
						<?php echo apms_widget('miso-shop-item-gallery', $wshid.'-gallery6', 'type=5 infi=1 garo=3 sero=5 sm=2 xs=1 hit=1 cmt=1 sns=1 thumb_w=400 thumb_h=600'); ?>

					<?php } else { //전체 ?>
						<?php echo apms_widget('miso-shop-item-gallery', $wshid.'-gallery1', 'infi=1 garo=3 sero=5 sm=2 xs=1 hit=1 cmt=1 sns=1 thumb_w=400 thumb_h=600'); ?>
					<?php } ?>
