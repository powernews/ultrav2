							...
							<div id="mixed_tab" class="div-tab tabs miso-tab swipe-tab">
								...
								<div class="tab-content">
									...
									<div class="tab-pane" id="main_mixed_b">
										<?php echo apms_widget('miso-post-mixed', $wshid.'-mixed-b', 'rows=9 grid=6 new=green rank=orange icon={아이콘:caret-right}'); ?>
										<div class="text-right main-more">
											<a href="<?php echo G5_BBS_URL;?>/board.php?bo_table=보드아이디">
									...
									<div class="tab-pane" id="main_mixed_c">
										<?php echo apms_widget('miso-post-mixed', $wshid.'-mixed-c', 'rows=9 grid=6 new=blue rank=green icon={아이콘:caret-right}'); ?>
										<div class="text-right main-more">
											<a href="<?php echo G5_BBS_URL;?>/board.php?bo_table=보드아이디">
							...
							<div id="gallery_tab" class="div-tab tabs miso-tab swipe-tab">
								...
								<div class="tab-content">
									...
									<div class="tab-pane" id="main_gallery_b">
										<?php echo apms_widget('miso-post-gallery', $wshid.'-gallery-b', 'garo=3 sero=2 ncut=40 sm=2 xs=2 new=blue rank=red'); ?>
										<div class="text-right main-more">
											<a href="<?php echo G5_BBS_URL;?>/board.php?bo_table=보드아이디">
									...
									<div class="tab-pane" id="main_gallery_c">
										<?php echo apms_widget('miso-post-gallery', $wshid.'-gallery-c', 'garo=3 sero=2 ncut=40 sm=2 xs=2 new=green rank=violet'); ?>
										<div class="text-right main-more">
											<a href="<?php echo G5_BBS_URL;?>/board.php?bo_table=보드아이디">
							...
							<div id="webzine_tab" class="div-tab tabs miso-tab swipe-tab">
								...
								<div class="tab-content">
									...
									<div class="tab-pane" id="main_webzine_b">
										<?php echo apms_widget('miso-post-webzine', $wshid.'-webzine-b', 'garo=2 sero=2 scut=30 rank=red ncut=40 new=red xs=1'); ?>
										<div class="text-right main-more">
											<a href="<?php echo G5_BBS_URL;?>/board.php?bo_table=보드아이디">
									...
									<div class="tab-pane" id="main_webzine_c">
										<?php echo apms_widget('miso-post-webzine', $wshid.'-webzine-c', 'garo=2 sero=2 scut=30 rank=green ncut=40 new=red xs=1'); ?>
										<div class="text-right main-more">
											<a href="<?php echo G5_BBS_URL;?>/board.php?bo_table=보드아이디">
