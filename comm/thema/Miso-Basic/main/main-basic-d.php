		...
		<div class="container">
			<div class="row main-row">
				<div class="col-md-9 main-col pull-right">
					...
					<div class="main-box">
						<div class="main-p10">
							<?php echo apms_widget('miso-slider', $wshid.'-title-slider', 'effect=fade nav=1 slider_h=40 rdm=1', 'slider_h=56'); //타이틀 위젯 ?>
						</div>
						<div class="main-box-footer bg-light">
							<?php echo apms_widget('miso-post-newsticker', $wshid.'-newsticker', 'effect=vertical date=Y.m.d new=red icon={아이콘:bell}'); // 뉴스티커 ?>
						</div>
					</div>
					<!-- //End -->
							...
							<div id="mixed_tab" class="div-tab tabs miso-tab swipe-tab">
								...
								<div class="tab-content">
									<div class="tab-pane active" id="main_mixed_a">
										<?php echo apms_widget('miso-post-mixed', $wshid.'-mixed-a', 'rows=9 grid=6 new=red icon={아이콘:caret-right}'); ?>
									...
									<div class="tab-pane" id="main_mixed_b">
										<?php echo apms_widget('miso-post-mixed', $wshid.'-mixed-b', 'rows=9 grid=6 new=green rank=orange'); ?>
										<div class="text-right main-more">
											<a href="<?php echo G5_BBS_URL;?>/board.php?bo_table=보드아이디">
									...
									<div class="tab-pane" id="main_mixed_c">
										<?php echo apms_widget('miso-post-mixed', $wshid.'-mixed-c', 'rows=9 grid=6 new=blue rank=green'); ?>
										<div class="text-right main-more">
											<a href="<?php echo G5_BBS_URL;?>/board.php?bo_table=보드아이디">
							...
							<div id="gallery_tab" class="div-tab tabs miso-tab swipe-tab">
								...
								<div class="tab-content">
									<div class="tab-pane active" id="main_gallery_a">
										<?php echo apms_widget('miso-post-gallery', $wshid.'-gallery-a', 'garo=3 sero=2 cut=24 ncut=80 sm=2 xs=2 new=red'); ?>
										<div class="text-right main-more">
											<a href="<?php echo G5_BBS_URL;?>/board.php?bo_table=보드아이디">
									...
									<div class="tab-pane" id="main_gallery_b">
										<?php echo apms_widget('miso-post-gallery', $wshid.'-gallery-b', 'garo=3 sero=2 cut=24 ncut=80 sm=2 xs=2 new=red rank=yellow'); ?>
										<div class="text-right main-more">
											<a href="<?php echo G5_BBS_URL;?>/board.php?bo_table=보드아이디">
									...
									<div class="tab-pane" id="main_gallery_c">
										<?php echo apms_widget('miso-post-gallery', $wshid.'-gallery-c', 'garo=3 sero=2 cut=24 ncut=80 sm=2 xs=2 new=red rank=navy'); ?>
										<div class="text-right main-more">
											<a href="<?php echo G5_BBS_URL;?>/board.php?bo_table=보드아이디">
							...
							<div id="webzine_tab" class="div-tab tabs miso-tab swipe-tab">
								...
								<div class="tab-content">
									<div class="tab-pane active" id="main_webzine_a">
										<?php echo apms_widget('miso-post-webzine', $wshid.'-webzine-a', 'garo=1 sero=4 img_w=160 cut=80 ncut=160 new=red'); ?>
										<div class="text-right main-more">
											<a href="<?php echo G5_BBS_URL;?>/board.php?bo_table=보드아이디">
									...
									<div class="tab-pane" id="main_webzine_b">
										<?php echo apms_widget('miso-post-webzine', $wshid.'-webzine-b', 'garo=1 sero=4 img_w=160 cut=80 ncut=160 new=red rank=blue'); ?>
										<div class="text-right main-more">
											<a href="<?php echo G5_BBS_URL;?>/board.php?bo_table=보드아이디">
									...
									<div class="tab-pane" id="main_webzine_c">
										<?php echo apms_widget('miso-post-webzine', $wshid.'-webzine-c', 'garo=1 sero=4 img_w=160 cut=80 ncut=160 new=red rank=red'); ?>
										<div class="text-right main-more">
											<a href="<?php echo G5_BBS_URL;?>/board.php?bo_table=보드아이디">
									...
									<div id="sero_tab" class="div-tab tabs miso-tab swipe-tab">
										...
										<div class="tab-content">
											<div class="tab-pane active" id="main_sero_a">
												<?php echo apms_widget('miso-post-mixed-sero', $wshid.'-mixed-sero-a', 'rows=7 in=black thumb_w=400 thumb_h=300 dadan=1 scut=15 new=red icon={아이콘:caret-right}'); ?>
												<div class="text-right main-more">
													<a href="<?php echo G5_BBS_URL;?>/board.php?bo_table=보드아이디">
											...
											<div class="tab-pane" id="main_sero_b">
												<?php echo apms_widget('miso-post-mixed-sero', $wshid.'-mixed-sero-b', 'rows=7 in=navy thumb_w=400 thumb_h=300 dadan=1 scut=15 new=blue icon={아이콘:caret-right}'); ?>
												<div class="text-right main-more">
													<a href="<?php echo G5_BBS_URL;?>/board.php?bo_table=보드아이디">
									...
									<div id="photo_tab" class="div-tab tabs miso-tab swipe-tab">
										...
										<div class="tab-content">
											...
											<div class="tab-pane" id="main_photo_b">
												<?php echo apms_widget('miso-post-photo', $wshid.'-photo-b', 'over=1 bg=deepblue garo=3 sero=2 xs=2 rank=orange'); ?>
												<div class="text-right main-more">
													<a href="<?php echo G5_BBS_URL;?>/board.php?bo_table=보드아이디">
				...
				<div class="col-md-3 main-col pull-left">
					...
					<div class="row main-row">
							...
							<div id="notice_tab" class="div-tab tabs miso-tab swipe-tab">
								...
								<div class="tab-content">
									<div class="tab-pane active" id="main_notice">
										<?php echo apms_widget('miso-post-list', $wshid.'-notice', 'rows=6 date=m.d new=red icon={아이콘:bell}'); ?>
										<div class="text-right main-more">
											<a href="<?php echo G5_BBS_URL;?>/board.php?bo_table=보드아이디">
						...
						<div class="col-md-12 col-sm-6 main-col">
							...
							<!-- 배너 Start //-->
							<div class="main-box main-p10">
								<?php echo apms_widget('miso-post-slider', $wshid.'-banner', 'rows=4 rdm=1 new=blue scut=20 caption=small bg=black trans=1'); ?>
							</div>
							<!-- //End -->
