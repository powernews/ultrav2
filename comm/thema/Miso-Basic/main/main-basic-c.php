							...
							<div class="row main-row">
								<div class="col-lg-12 col-sm-6 main-col">
									...
									<div class="main-box main-p10">
										<?php echo apms_widget('miso-post-slider', $wshid.'-slider', 'effect=vertical caption=small scut=20 bg=black trans=1 rows=4 rdm=1 new=red'); ?>
									</div>
									<!-- //End -->
									...
									<div id="photo_tab" class="div-tab tabs miso-tab swipe-tab">
										...
										<div class="tab-content">
											...
											<div class="tab-pane" id="main_photo_b">
												<?php echo apms_widget('miso-post-photo', $wshid.'-photo-b', 'over=1 bg=crimson garo=3 sero=2 xs=2 rank=orange'); ?>
												<div class="text-right main-more">
													<a href="<?php echo G5_BBS_URL;?>/board.php?bo_table=보드아이디">
				...
				<div class="col-md-3 main-col">
					...
					<div class="row main-row">
						...
						<div class="col-md-12 col-sm-6 main-col">
							...
							<!-- 배너 Start //-->
							<div class="main-box main-p10">
								<?php echo apms_widget('miso-post-slider', $wshid.'-banner', 'rows=4 rdm=1 new=blue nav=1'); ?>
							</div>
							<!-- //End -->
