...
<style>
	...
	.page-content th.blank { border: 0px !important; }
	.page-content .history .nav-tabs { border-bottom:0px !important; }
	.page-content .history .nav-tabs li { margin-bottom:0px !important; }
	.page-content .history .nav-tabs li a { border-bottom:0px !important; }
	.page-content .history .tab-content { border:0 !important; padding:0 !important; }
	.page-content .page-nav { margin-top:10px; }
	@media all and (max-width:460px) {
		.responsive .page-content .page-nav { display:none; }
	}
</style>
