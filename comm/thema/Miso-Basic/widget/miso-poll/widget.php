						...
						<form class="form" role="form" name="fpoll<?php echo $i;?>" action="<?php echo G5_BBS_URL; ?>/poll_update.php" onsubmit="return fpoll_submit(this,'<?php echo $list[$i]['po_level'];?>');" method="post">
							...
							<div class="text-center">
								<div class="btn-group">
									...
									<a href="<?php echo G5_BBS_URL;?>/poll_result.php?po_id=<?php echo $list[$i]['po_id'];?>&amp;skin_dir=<?php echo urlencode($skin_dir);?>" target="_blank" onclick="fpoll_result(this.href, '<?php echo $list[$i]['po_level'];?>'); return false;" class="btn btn-black btn-sm"><i class="fa fa-bar-chart"></i> 결과</a>
