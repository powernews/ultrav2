			...
			<div class="pc-header">
				<div class="at-container">
					...
					<div class="header-logo">
						<table cellpadding="0" cellspacing="0" style="width:100%; border: 1px red solid;">
						<tr>
						<td style="width:0px;"></td>
						<td><a href="<?php echo $at_href['home'];?>">
						<img src="/comm/thema/Miso-Basic/assets/img/info_logo.png" width="200px"></a></td>
					...
					<ul>
						...
						<?php } else { // 로그아웃 상태 ?>
							...
							<li><a href="<?php echo $at_href['lost'];?>" class="win_password_lost">정보찾기</a></li>
								...
								<div class="header-search" style="margin-top: -15px; margin-left: -4px;">
									<form name="tsearch" method="get" onsubmit="return tsearch_submit(this);" role="form" class="form">
										<input type="hidden" name="url"	value="<?php echo (IS_YC) ? $at_href['isearch'] : $at_href['search'];?>">
										<div class="input-group input-group-sm">
											<input type="text" name="stx" class="form-control input-sm" value="<?php echo $stx;?>"  style="border: 0px solid #fff; border-bottom: 1px solid #111;">
				...
				<div class="clearfix"></div>
					...
					<div class="header-search">
						...
						<div class="header-keyword">
							<?php echo apms_widget('miso-keyword', 'miso-keyword', 'q=울트라브이코스메틱'); // 키워드 ?>
						</div>
					</div>
					<div class="clearfix"></div>
				</div>
