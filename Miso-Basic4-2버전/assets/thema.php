...
//$sns_share_icon .= get_sns_share_link('twitter', $sns_share_url, $sns_share_title, $sns_share_img.'/insta.gif').PHP_EOL;
...
//$sns_share_icon .= '<a href="http://blog.naver.com/wmmodel" target="_blank"><img src="http://www.ultravcosmetic.com/comm/thema/Miso-Basic4/assets/img/blog.gif" alt="Blog" title="블로그 바로가기"></a>'.PHP_EOL;
//$sns_share_icon .= '<a href="https://www.instagram.com/ultravcosmetic/" target="_blank"><img src="http://www.ultravcosmetic.com/comm/thema/Miso-Basic4/assets/img/insta.gif" alt="Blog" title="블로그 바로가기"></a>'.PHP_EOL;
//$sns_share_icon .= '<a href="https://www.facebook.com/ultravmaster/" target="_blank"><img src="http://www.ultravcosmetic.com/comm/thema/Miso-Basic4/assets/img/sns_fb.png" alt="Blog" title="블로그 바로가기"></a>'.PHP_EOL;
