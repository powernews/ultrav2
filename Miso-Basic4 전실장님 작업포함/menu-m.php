	...
	<div class="at-container">
		<div class="m-table en">
			...
			<?php if(IS_YC) { // 영카트 이용시 ?>
				<div class="m-icon">
					2222<a href="<?php echo $at_href['change'];?>">
			...
			<div class="m-list">
				<div class="m-nav" id="mobile_nav">
					<a href="<?php echo $at_href['home'];?>">
						<span class="header-logo"><center><img src="/comm/thema/Miso-Basic/assets/img/info_logo.png" width="100px" height="30px"></center></span></a>
					<!--
					<ul class="clearfix">
					<li>
